               ...
               <div class="col-md-2"></div>
                <div class="col-md-8 ">
                    <div class="panel panel-info">
                        ...
                        <a href="{{ route('all_salary') }}" class="pull-right btn btn-danger btn-sm" style="margin-top: -40px;">All Advanced Salary</a>
                        @if ($errors->any())
                        ...
                        <div class="panel-body">
                            <form role="form" action="{{ url('/insert_advancedsalary') }}" method="post" enctype="multipart/form-data">
                                @csrf
